...
const Blogs = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-between container mx-auto items-center p-6 gap-4">
